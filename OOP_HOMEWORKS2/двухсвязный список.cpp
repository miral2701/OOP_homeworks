//Написать метод void DelRange(int pos1, int pos2), который 
//удаляет все элементы 2 - св.списка, начиная
//с позиции pos1 и до pos2(включительно).Не использовать метод Del(), 
//а вручную связать элементы списка(новых соседей)!
...
void List::Insert(int pos)
{
 ...
 //то запрашиваем его
	...
	// Доходим до элемента,
	// после которого будем вставлять
...
void List::DelRange(int pos1, int pos2) {
	...
	//Если удаляем не голову и не хвост
